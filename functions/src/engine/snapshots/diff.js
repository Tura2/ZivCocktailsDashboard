...
exports.computeDiffFromPreviousPct = computeDiffFromPreviousPct;
/**
...
function computeDiffFromPreviousPct(current, previous) {
    return {
        ...
        marketing: {
            ...
            landingConversionPct: diffCountLeaf(current.marketing.landingConversionPct.value, previous.marketing.landingConversionPct.value),
            followersEndOfMonth: diffCountLeaf(current.marketing.followersEndOfMonth.value, previous.marketing.followersEndOfMonth.value),
            followersDeltaMonth: diffCountLeaf(current.marketing.followersDeltaMonth.value, previous.marketing.followersDeltaMonth.value),
        },
        sales: {
        ...
        operations: {
            ...
            referralsWordOfMouth: diffCountLeaf(current.operations.referralsWordOfMouth.value, previous.operations.referralsWordOfMouth.value),
            returningCustomers: diffCountLeaf(current.operations.returningCustomers.value, previous.operations.returningCustomers.value),
        },
    };
}
